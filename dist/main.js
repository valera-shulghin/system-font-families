...
var SystemFonts = function SystemFonts() {
    ...
    var getFontFiles = function getFontFiles() {
        ...
        if (platform === 'osx') {
            ...
            directories = [].concat(_toConsumableArray(directories), [_path2.default.join(winDir, 'Fonts'), _path2.default.join(_os2.default.homedir(), 'AppData', 'Roaming', 'Adobe', 'CoreSync', 'plugins', 'livetype', 'r')]);
        } else {
    ...
    this.getFontsSyncWithPaths = function () {
        var names = _this.getFontsExtendedSync();
        var fonts = names.map(function (font) {
